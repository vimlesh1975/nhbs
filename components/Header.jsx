      ...
      <div className="max-w-[1800px] mx-auto flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
            AMCP Protocol Routing: <span className="font-mono text-emerald-600 dark:text-emerald-300 font-bold">{channel}-2</span> Headlines | <span className="font-mono text-cyan-600 dark:text-cyan-300 font-bold">{channel}-3</span> Oneliner | <span className="font-mono text-blue-600 dark:text-blue-300 font-bold">{channel}-4</span> Twoliner
          </p>
        </div>
