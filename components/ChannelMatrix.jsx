      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">AMCP Protocol Routing: <span className="font-mono text-emerald-600 dark:text-emerald-300 font-bold">1-2</span> Headlines | <span className="font-mono text-cyan-600 dark:text-cyan-300 font-bold">1-3</span> Oneliner | <span className="font-mono text-blue-600 dark:text-blue-300 font-bold">1-4</span> Twoliner</p>
          </div>
        </div>
